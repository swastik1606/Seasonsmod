...
@Mod.EventBusSubscriber(modid = SeasonsMod.MOD_ID, bus = Mod.EventBusSubscriber.Bus.FORGE, value = Dist.CLIENT)

public class SeasonParticles {
    ...
    public static void onClientTick(TickEvent.ClientTickEvent event) {
        ...
        if (season != Season.WINTER && season != Season.AUTMN && season != Season.SPRING)
            return;
        ...
        for (int i = 0; i < 25; i++) {
            ...
            if (!mc.level.canSeeSky(checkPos))
                continue;
